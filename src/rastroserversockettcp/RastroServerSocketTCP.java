 ...
 */
public class RastroServerSocketTCP {
    ...
    private void tratarConexao(Socket socket) throws IOException, ClassNotFoundException
    {
        try {            
            ...
            Logger.getLogger(RastroServerSocketTCP.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
            fechaSocket(socket);
        }           
    }
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try {
            RastroServerSocketTCP server = new RastroServerSocketTCP();
